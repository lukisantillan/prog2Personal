...
gcc -o build/program.out $main libs/elementos/$elementos libs/listas/$listas libs/pilas/$pilas libs/colas/$colas libs/nodos/$nodo libs/arboles/$arbolBinario libs/arboles/$arbolBusqueda libs/arboles/$arbolAvl 
./build/program.out